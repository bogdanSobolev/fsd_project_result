...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-room__filter-btn').on('click', function (e) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).toggleClass('search-room__filter-btn_active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).siblings('.search-room__aside-form').toggleClass('search-room__aside-form_active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).siblings('.search-room__aside-form');
});
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			[8347,377,270,526,558,439,945,688,661]
/******/ 		];
